...
test('Gen 1:1-2:4', function(){
  ...
  assert.deepEqual(b.references,
    [ { bookId: 1, chapter: 1, startVerse: 1, endVerse: 25 },
      { bookId: 1, chapter: 2, startVerse: 1, endVerse: 4 } ]
  );
});
...
test('Gen 1:1-2:4; 3:1-3:11', function(){
  ...
  assert.deepEqual(b.references,
    [ { bookId: 1, chapter: 1, startVerse: 1, endVerse: 25 },
      { bookId: 1, chapter: 2, startVerse: 1, endVerse: 4 },
      { bookId: 1, chapter: 3, startVerse: 1, endVerse: 11 },
   ]
  );
});
...
test('Gen 1:1-2:4; Lev 3:1-3:11', function(){
  ...
  assert.deepEqual(b.references,
    [ { bookId: 1, chapter: 1, startVerse: 1, endVerse: 25 },
      { bookId: 1, chapter: 2, startVerse: 1, endVerse: 4 },
      { bookId: 3, chapter: 3, startVerse: 1, endVerse: 11 },
   ]
  );
});
...
test('Gen 1:1-2:4, 2:14-16; Lev 3:1-3:11; 3:13-16', function(){
  ...
  assert.deepEqual(b.references,
    [ { bookId: 1, chapter: 1, startVerse: 1, endVerse: 25 },
      { bookId: 1, chapter: 2, startVerse: 1, endVerse: 4 },
      { bookId: 1, chapter: 2, startVerse: 14, endVerse: 16 },
      { bookId: 3, chapter: 3, startVerse: 1, endVerse: 11 },
      { bookId: 3, chapter: 3, startVerse: 13, endVerse: 16 },
   ]
  );
});
...
test('Gen 1:4-,2:3', function(){
  ...
  assert.deepEqual(b.references,
    [ { bookId: 1, chapter: 1, startVerse: 4, endVerse: 25 },
      { bookId: 1, chapter: 2, startVerse: 3, endVerse: 3 },
   ]
  );
});
...
test('Gen 1:4-; 2 ; 3:3', function(){
  ...
  assert.deepEqual(b.references,
    [ { bookId: 1, chapter: 1, startVerse: 4, endVerse: 25 },
      ...
      { bookId: 1, chapter: 3, startVerse: 3, endVerse: 3 },
...
test("Iterator", function(){
  ...
  var it = b.iterator();
  var v = it.next();
  assert.deepEqual(v,{ bookId: 1, chapter: 1, verse: 2 });
  v = it.next();
  assert.deepEqual(v,{ bookId: 1, chapter: 1, verse: 4 });
  v = it.next();
  assert.deepEqual(v,{ bookId: 1, chapter: 1, verse: 6 });
  v = it.next();
  assert.deepEqual(v,{ bookId: 1, chapter: 1, verse: 8 });
  v = it.next();
